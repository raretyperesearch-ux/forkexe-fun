                ...
                <div style={{ 
                  ...
                  <div style={{ display: 'flex', gap: '16px' }}>
                    <div style={{ 
                      ...
                      <span style={{ color: colors.textSecondary, fontSize: '11px', textTransform: 'uppercase', fontWeight: 500 }}>Moltbook Agents:</span>
                      <span style={{ color: '#EF4444', fontWeight: 700, fontSize: '16px' }}>1,000</span>
                    </div>
                    <div style={{ 
                      display: 'flex', 
                      alignItems: 'center', 
                      ...
                      <span style={{ color: colors.textSecondary, fontSize: '11px', textTransform: 'uppercase', fontWeight: 500 }}>Tokenized (50+ Karma):</span>
                      <span style={{ color: '#3B82F6', fontWeight: 700, fontSize: '16px' }}>{moltbookAgents.filter(a => a.karma >= 50).length}</span>
                    </div>
                    <div style={{ 
                      display: 'flex', 
                      alignItems: 'center', 
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                    ...
                    <span style={{ color: colors.textSecondary, fontSize: '12px' }}>agentscreener</span>
                    <span style={{ color: colors.textSecondary, fontSize: '12px' }}>powered by</span>
                    <span style={{ color: '#EF4444', fontWeight: 600, fontSize: '12px' }}>moltbook</span>
                    <span style={{ color: colors.textSecondary, fontSize: '12px' }}>×</span>
                    <span style={{ color: '#0052FF', fontWeight: 600, fontSize: '12px' }}>bankr</span>
                  </div>
                </div>
