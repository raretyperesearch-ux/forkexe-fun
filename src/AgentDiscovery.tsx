...
function ScreenerPage() {
  ...
  const [sourceFilter, setSourceFilter] = useState<'all' | 'verified' | 'trending' | 'top10' | 'bankr' | 'clanker' | 'agent' | 'clawnch' | 'moltlaunch' | 'creatorbid'>('trending');
              ...
              <>
                ...
                <div style={{ 
                  ...
                  {[
                    ...
                    { key: 'clawnch', label: 'Clawnch' }, { key: 'moltlaunch', label: 'Moltlaunch' }, { key: 'creatorbid', label: 'CreatorBid' },
